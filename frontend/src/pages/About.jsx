      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600">
            Welcome to BidOn, the ultimate destination for online auctions
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            At BidOn, our mission is to revolutionize the way people buy and
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Aniket Yadav, BidOn was born out of a passion for
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, BidOn
        ...
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            Thank you for choosing BidOn. We look forward to being a part of
